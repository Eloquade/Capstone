            ...
            <div style=" background: black;" >
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">
                    ...
                    <div class="pull-right" style="border: 2px solid black;">
                       <?php $qry1=mysqli_query($con,"SELECT * from tblresident r left join tblindigency c on c.residentid = r.id where residentid = '".$_GET['resident']."' and fullname = '".$_GET['fullname']."' ");
                    ...
                    <div class="col-xs-12 col-md-12">
                        <p class="text-center" style="font-size: 20px; font-size:bold;">OFFICE OF THE BARANGAY CAPTAIN<br><b style="font-size: 28px;">BARANGAY INDIGENCY</b></p>
                        ...
                        <?php
                            $qry=mysqli_query($con,"SELECT * from tblresident r left join tblindigency c on c.residentid = r.id where residentid = '".$_GET['resident']."' and fullname = '".$_GET['fullname']."' ");
                            while($row = mysqli_fetch_array($qry)){
                                ...
                                <p><b>
                                    RES. CERT. NO.: <u>'.strtoupper($row['fullname']).'</u><br>
                ...
                <div class="col-xs-3 pull-right" style="margin-bottom:40px;">
                    ...
                    <span class="pull-right"><?php echo substr_replace($_GET['indigency'],'****',0,3);?> </span>
