                                        ...
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                if(!isset($_SESSION['staff']))
                                                {
                                                    ...
                                                    $squery = mysqli_query($con, "SELECT *,CONCAT(fullname) as fullname,p.id as pid FROM tblindigency p left join tblresident r on r.id = p.fullname  where status = 'Approved'") or die('Error: ' . mysqli_error($con));
                                                    while($row = mysqli_fetch_array($squery))
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <a target="_blank" href="indigency_form.php?resident='.$row['fullname'].'&indigency='.$row['fullname'].'&val='.base64_encode($row['fullname'].'|'.$row['fullname'].'|'.$row['dateRecorded']).'" onclick="location.reload();" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Generate</a></td>
                                                        </tr>
                                                        ';
