                                ...
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        ?>
                                                ...
                                                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Events</button>  
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            {   
                                                ...
                                                $squery = mysqli_query($con, "select * from tblevents");
