...
if(isset($_POST['btn_add'])){
   ...
   // $chkdup = mysqli_query($con, "SELECT * from tblactivity where householdno = ".$txt_householdno." ");
    ...
    //if($num_rows == 0){
        $query = mysqli_query($con,"INSERT INTO tblevents (activity,description) 
            values ('$txt_act', '$txt_desc')") or die('Error: ' . mysqli_error($con));
...
if(isset($_POST['btn_save']))
{
    ...
    $update_query = mysqli_query($con,"UPDATE tblevents set activity = '".$txt_edit_act."', description = '".$txt_edit_desc."' where id = '".$txt_id."' ") or die('Error: ' . mysqli_error($con));
...
if(isset($_POST['btn_delete']))
{
    if(isset($_POST['chk_delete']))
    {
        ...
        {
            $delete_query = mysqli_query($con,"DELETE from tblevents where id = '$value' ") or die('Error: ' . mysqli_error($con));
