                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                $squery = mysqli_query($con, "SELECT *,CONCAT(fullname) as fullname,p.id as pid FROM tblpermit p left join tblresident r on r.id = p.residentid where status = 'Approved'") or die('Error: ' . mysqli_error($con));
                                    ...
                                    <table id="table1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                $squery = mysqli_query($con, "SELECT *,CONCAT(fullname) as fullname,p.id as pid FROM tblpermit p left join tblresident r on r.id = p.residentid where status = 'Disapproved' ") or die('Error: ' . mysqli_error($con));
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    echo '
                                                    <tr>
