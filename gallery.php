...
<body>
    <header class="header-blue" style="background: rgb(255,255,255);">
        ...
        <ul class="nav nav-tabs" style="background: rgb(5,23,33);">
            <li class="nav-item"><a class="nav-link text-light" href="event.html" style="font-family: 'Akaya Kanadaka', cursive;">Home</a></li>
            ...
            <li class="nav-item"><a class="nav-link active text-justify text-light" href="index.html" style="background: rgb(38,104,102);color: rgb(248, 249, 250);font-family: 'Akaya Kanadaka', cursive;">Gallery</a></li>
            <li class="nav-item"><a class="nav-link text-light" href="event.html" style="font-family: 'Akaya Kanadaka', cursive;">Events</a></li>
        ...
        <h1 class="text-center " style="background: #B0C4DE; color: black; text-shadow: 2px 2px 4px #f7f8f8; font-family: 'Akaya Kanadaka', cursive;font-family: 'Akaya Kanadaka', cursive;" >Gallery</h1>
        ...
        <div class="container py-5">
            <div class="row mt-4">
                ...
                if($check_images)
                {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <img src="" <?php echo $row['filename']; ?> class="card-img-top" alt="Gallery Images">
